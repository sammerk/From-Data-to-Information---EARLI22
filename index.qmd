...
* Take Home:
    * Sensitive *and* accurate perception data are prerequisites for adequate data based actions
    * (Pre-service) Teachers percept mean difference accurate but insensitive.
    * (Pre-service) Teachers quickly improve their efficiency in judging mean differences
...
::: incremental
-   Key results
    -   Teachers notice dispersion mainly nonspecifically or as minimum and maximum but not as distance from the mean\
...
-   Relevant to consider
    -   Appropriate data analysis is necessary but not sufficient for DBDM (→ conceptual DBDM models)
    -   Successful interaction of teachers and technology [@mandinach2021]
:::
